...
<head>
  ...
  <style>
    ...
    .date-range, .mode-info, .category-info {
      text-align: center;
      margin-top: -5px;
      margin-bottom: 10px;
      font-size: 15px;
...
<div class="report-container">
  ...
  <div class="category-info">
    Category: <strong><?= htmlspecialchars($category ?: 'All') ?></strong>
  </div>
  <div class="mode-info">
    Mode: <strong><?= htmlspecialchars($mode ?: 'All') ?></strong>
  </div>
